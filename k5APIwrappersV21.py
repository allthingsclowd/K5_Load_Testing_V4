...
def list_servers_with_filter(k5token, project_id, filter, region):
    """Summary - list  K5 projects
    ...
    try:
        ...
        serverURL = 'https://compute.' + region + \
            '.cloud.global.fujitsu.com/v2/' + project_id + '/servers?' + unicode(filter)
        response = requests.get(serverURL,
                                headers={
                                     'X-Auth-Token': k5token,
                                     'Content-Type': 'application/json',
...
def update_port_sg(k5token, port_id, security_groups, region):
    """Summary
...
def main():
   ...
   #  result = create_new_storage_container(k5token, demoProjectAid, "K5_Test_Results")
   #  print result

   #  k5loadresults = []
   #  k5loadresults = json.dumps(k5loadresults)
   #  result = upload_object_to_container(k5token, demoProjectAid, "K5_Test_Results", k5loadresults, "k5loadtestresults.json")
   #  result = upload_object_to_container(k5token, demoProjectAid, "K5_Test_Results", k5loadresults, "k5currenttestresults.json")
   #  print result

   #  # with open('https://objectstorage.uk-1.cloud.global.fujitsu.com/v1/AUTH_7015d1478a4c4bd7b970215d7b0260dd/K5_Test_Results/k5loadtestresults.json') as json_data:
   #  #     d = json.load(json_data)
   #  #     json_data.close()
   #  #     pprint(d)

   #  result = download_item_in_storage_container(k5token, demoProjectAid, "K5_Test_Results", "k5loadtestresults.json", region)
   ...
   #  print k5token.json()
    ...
    # k5resultcontainer = "K5_ResultsApples"
    ...
    # print len(list_servers_with_filter(k5tokenA, demoProjectAid, "status=ACTIVE", region).json()['servers'])
    # try:
    ...
    #     result = create_new_storage_container(k5tokenA, demoProjectAid, k5resultcontainer)
    #     result = []

    # #result.append({bananas})
    # result = json.dumps(result)
    # result = upload_object_to_container(k5tokenA, demoProjectAid, k5resultcontainer, result, k5testrecords)
    # print "Results can be located at the above url"
    ...
    # RouterAZ1 = [{u'destination': u'10.10.10.0/24', u'nexthop': u'192.168.10.2'}, {'destination': '10.10.9.0/24', 'nexthop': u'192.168.10.4'}, {u'destination': u'10.10.8.0/24', u'nexthop': u'192.168.10.5'}, {'destination': '10.10.7.0/24', 'nexthop': u'192.168.10.6'}, {u'destination': u'10.10.6.0/24', u'nexthop': u'192.168.10.7'}, {'destination': '10.10.5.0/24', 'nexthop': u'192.168.10.8'}, {u'destination': u'10.10.4.0/24', u'nexthop': u'192.168.10.9'}, {'destination': '10.10.3.0/24', 'nexthop': u'192.168.10.10'}, {u'destination': u'10.10.2.0/24', u'nexthop': u'192.168.10.11'}, {'destination': '10.10.1.0/24', 'nexthop': u'192.168.10.12'}]
    # RouterAZ2 = [{'destination': '192.168.10.0/24', 'nexthop': u'10.10.10.2'}]
    # serverips = []
    # print serverips
    k5token = get_scoped_token(adminUser, adminPassword, contract, demoProjectAid, region).headers['X-Subject-Token']
    ...
    # routerA ='6a54320f-025b-4d6b-9efa-07fb8c2f8b2b'
    # routerB ='f902d572-d73a-463b-96bb-2c10777dfbc6'
    # RouterAZ1 = [{u'destination': u'10.10.1.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.2.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.3.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.4.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.5.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.6.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.7.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.8.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.9.0/24', u'nexthop': u'192.168.1.2'}, {u'destination': u'10.10.10.0/24', u'nexthop': u'192.168.1.2'}]
    # RouterAZ2 = [{u'destination': u'192.168.1.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.2.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.3.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.4.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.5.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.6.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.7.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.8.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.9.0/24', u'nexthop': u'10.10.1.2'}, {u'destination': u'192.168.10.0/24', u'nexthop': u'10.10.1.2'}]
    # print show_router(k5token, routerA , region).json()
    # print show_router(k5token, routerB, region).json()
    # print update_router_routes(k5token, routerA, RouterAZ1, region).json()
    # print update_router_routes(k5token, routerB, RouterAZ2, region).json()
    # print show_router(k5token, routerA , region).json()
    # print show_router(k5token, routerB, region).json()
    # #print k5token
    # routerA = '1667d58c-762b-4041-a2fe-b159fc8db3cc'
    # routerB = 'c84cf4c7-117e-4ab2-bbcd-2b7dba90125e'
    # print show_router(k5token, routerA , region).json()
    # print show_router(k5token, routerB, region).json()
    # print update_router_routes(k5token, routerA, RouterAZ1, region).json()
    # print update_router_routes(k5token, routerB, RouterAZ2, region).json()
    ...
    #     print network.get('id'), network.get('name')
    # print list_networks(k5token, region).json()['networks']
    # print list_ports(k5token,region).json()['ports']
    # security_groups = ['0f2281f1-c94f-4ce0-b2b9-0317033ff158','d493e175-d596-4084-ba9e-23665be8730c']
    # print update_port_sg(k5token, 'ebe210ae-95ea-4447-8322-733c024c520a', security_groups, region).json()
    # print list_ports(k5token,region).json()['ports']
    print list_routers(k5token,region).json()['routers']
    # routerA ='6a54320f-025b-4d6b-9efa-07fb8c2f8b2b'
    # routerB ='f902d572-d73a-463b-96bb-2c10777dfbc6'
    # RouterAZ1 = [{u'destination': u'10.10.0.0/16', u'nexthop': u'192.168.1.2'}]
    # RouterAZ2 = [{u'destination': u'192.168.0.0/16', u'nexthop': u'10.10.1.2'}]
    # print show_router(k5token, routerA , region).json()
    # print show_router(k5token, routerB, region).json()
    # print update_router_routes(k5token, routerA, RouterAZ1, region).json()
    # print update_router_routes(k5token, routerB, RouterAZ2, region).json()
    ...
    # print list_network_connectors(k5token,region).json()
    # print show_network_connector_details(k5token, 'c35e9fa8-fa1e-40aa-9ac3-4d74584544a3', contract, region).json()
    # print show_network_connector_ep_interfaces(k5token, 'cedd3436-32b9-412f-b21d-777a3abd1384', region).json()
    # print show_network_connector_ep_interfaces(k5token, '10a3772e-fa09-4027-aadf-38905ea34a60', region).json()

    # for kp in list_keypairs(k5token, demoProjectAid, region).json()['keypairs']:
    #     key = show_keypair(k5token, kp.get('keypair').get('name'), demoProjectAid, region).json()['keypair'].get('id')
    #     print key
    #     print "\nKey ID \n", key.get('id'), "\nKey Name \n", key.get('name'), "\nPublic Key \n", key.get('public_key'), "\nEverything  \n", key
